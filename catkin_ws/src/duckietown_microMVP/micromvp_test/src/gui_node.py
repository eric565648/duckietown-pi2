...
class App(gui.Desktop):
    def __init__(self, **params):
        ...
        self.carpub = rospy.Publisher("~micromvp", micromvp_carspeed)
    ...
    def SendSpeed(self):
        ...
        while True:
            ...
            if run:
                ...
                car_msg.lspeed = newList2
                car_msg.rspeed = newList3
...
if __name__ == "__main__":
    rospy.init_node('publisher_nodesudo ')
    app = App()
